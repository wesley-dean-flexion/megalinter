...
- Linter versions upgrades
  ...
  - [checkov](https://www.checkov.io/) from 2.1.103 to **2.1.105** on 2022-08-09
  - [gitleaks](https://github.com/zricethezav/gitleaks) from 8.9.0 to **8.10.1** on 2022-08-09
  - [rubocop](https://rubocop.org/) from 1.33.0 to **1.34.0** on 2022-08-09
  - [cspell](https://github.com/streetsidesoftware/cspell/tree/master/packages/cspell) from 6.5.0 to **6.6.0** on 2022-08-09
  - [terragrunt](https://terragrunt.gruntwork.io) from 0.38.6 to **0.38.7** on 2022-08-09
<!-- linter-versions-end -->
